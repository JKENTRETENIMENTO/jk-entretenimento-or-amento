...
export default function JKEntretenimentoApp() {
  ...
  const montarMensagem = () => {
    ...
    return `Olá, meu nome é ${nome}. Gostaria de montar meu evento com os seguintes dados:%0A
Data: ${data}%0A
Horário: ${horario}%0A
...
Email: ${email}`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-[#0b0016] to-[#1a002d] text-white p-4 flex flex-col items-center">
      ...
      <h1 className="text-3xl font-bold mb-2 text-center">Monte seu Evento - JK Entretenimento</h1>
      <p className="text-center text-purple-400 mb-4">Para gerar o orçamento, precisamos que você monte seu evento abaixo!</p>
